...
{
    /// <inheritdoc />
    public partial class Updateeded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DescrptionAr = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
                    DescrptionEn = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileExetension = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ImageProducts_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ImageProducts_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_NameEn_NameAr",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageProducts_CreatedById",
                table: "ImageProducts",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImageProducts_UpdatedById",
                table: "ImageProducts",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_NameEn_NameAr",
                table: "Products",
                columns: new[] { "NameEn", "NameAr" },
                unique: true);
